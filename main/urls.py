...
from main.views import add_news_entry_ajax, delete_news, edit_news, login_user, logout_user, register, show_main, create_news, show_news, show_xml, show_json, show_xml_by_id, show_json_by_id, proxy_image, create_news_flutter
